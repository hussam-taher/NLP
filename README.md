...
<!--
“Adapted from Hugging Face Transformers example run_glue.py, modified for IMDb sentiment classification, additional metrics and result logging were added.”
-->
